...
export const User = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 1024 1024" className="rounded-full w-full h-full"><path fill="#808080" d="M288 320a224 224 0 1 0 448 0a224 224 0 1 0-448 0m544 608H160a32 32 0 0 1-32-32v-96a160 160 0 0 1 160-160h448a160 160 0 0 1 160 160v96a32 32 0 0 1-32 32z"/>
        </svg>
    )
}