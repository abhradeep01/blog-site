...
function NavBar() {
  ...
  return (
    <>
        <div className="w-[100%] h-24 fixed right-0 left-0 top-0 z-20 flex flex-row justify-around items-center bg-slate-200 mid:justify-between mid:px-2">
            <div className="w-20">
                <Link to={'/'} children={
                    <img src={logo} alt="" />
                }/>
            </div>
            <div className="w-fit flex flex-row items-center gap-2 mid:hidden">
                ...
                <div className="w-14 h-14 rounded-full flex items-center justify-center bg-cyan-500  hover:text-white">
                    <Link to='/write' children='Write' className='text-[0.95rem] font-semibold' />
                </div>
            </div>
            <div className="hidden mid:w-fit mid:flex mid:flex-row mid:gap-2 mid:items-center">
